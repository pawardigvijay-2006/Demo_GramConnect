...
public class PropertyTaxBill {
        ...
        // MAIN METHOD
        // ============================================================
        public  Scene getPropertyTaxBillScene(Runnable backAction) {

                BorderPane root = new BorderPane();
                root.setStyle("-fx-background-color: #F4F8FB;");
                BillManagement billManagement = new BillManagement();
                // SAME SIDEBAR AS BILL MANAGEMENT
                root.setLeft(billManagement.buildSidebar(backAction));

                // HEADER + PROPERTY TAX CONTENT
                ...
                leftColumn.prefWidthProperty().bind(columns.widthProperty().multiply(0.65));

                rightColumn.prefWidthProperty().bind(columns.widthProperty().multiply(0.35));
                ...
                // ========================================================
                // SCROLLABLE PROPERTY TAX CONTENT
                // ========================================================
...
BackgroundImage backgroundImage =
        ...
        private static VBox buildOwnerInformation() {
                ...
                TextField propertyId = createTextField("Enter Property ID");
                TextField ownerName = createTextField("Full Legal Name");
                TextField mobile = createTextField("+91");
                TextField email = createTextField("owner@example.com");
                TextField address = createTextField("Complete property address");
                ComboBox<String> ward = createComboBox("Select Ward");
        ...
        private static VBox buildPropertyDetails() {
                ...
                ComboBox<String> propertyType = createComboBox("Select Property Type");
                ComboBox<String> usageType = createComboBox("Select Usage");

                TextField propertyNumber = createTextField("PROP-2024-002");
                TextField surveyNumber = createTextField("e.g. 125/1A");
                TextField propertyArea = createTextField("125.50");
                TextField builtUpArea = createTextField("110.00");
                TextField totalFloors = createTextField("2");
                TextField constructionYear = createTextField("2018");
        ...
        private static VBox buildTaxAssessment() {
                ...
                TextField assessmentYear = createTextField("2024 - 2025");
                TextField assessmentValue = createTextField("0.00");
                TextField baseTax = createTextField("0.00");
                TextField sanitationTax = createTextField("0.00");
                TextField educationCess = createTextField("0.00");
                TextField previousArrears = createTextField("0.00");
                TextField lateFee = createTextField("0.00");
                TextField discount = createTextField("0.00");
        ...
        private static VBox buildCalculationSummary() {
                ...
                HBox baseTax = summaryRow("Base Tax", "₹0.00");

                HBox additionalTax = summaryRow("Additional Taxes", "₹0.00");

                HBox arrears = summaryRow("Arrears & Penalties", "₹0.00");

                HBox discount = summaryRow("Total Discounts", "₹0.00");
        ...
        private static VBox buildPaymentStatus() {
                ...
                TextField referenceId = createTextField(
                                "e.g. TXN-12345");
